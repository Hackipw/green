...
def hero():
    ...
    while(y):
        ...
        if i in thatway:
            m=getSum(current)+1
            n=int(current)%10
            if((m%2==0 and 2==0) or (m%2==1 and n%2==1)):
                if current in numbers:
                    print(newperiod+1,": RED")
                else:
                    print(newperiod+1,": GREEN")
        ...
        if (len(numbers)>31):
            clear()
            system('figlet Thank youðŸ¤‘!!')
            print("Play on next specified timeðŸ¤‘!!")
            print("-----------â±ï¸Current Time UPâ±ï¸----------")
...
if(expirydate>today):
    ...
    if (True):
        ...
        banner='figlet RXCE'
        print("Hi!! ðŸ¤‘Thanks for buying the hackðŸ¤‘")
        print("----------âŒ›Your play timeâŒ„1¤7----------")
        ...
        (" Channel join krle bhosdkeðŸ˜ @RXCE HACK ")
